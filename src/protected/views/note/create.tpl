...
<div class='noteForm'>
    ...
    <div class='line'>
        ...
        <div class='input'>
            <input name="NoteForm[boxName]" type='text' class='boxNameInput' id='boxNameInput' value="{{$myBoxes[0]['name']}}"/>
            <input name="NoteForm[boxId]" id="NoteForm_boxId" type="hidden" class="error" value="{{$myBoxes[0]['id']}}">
