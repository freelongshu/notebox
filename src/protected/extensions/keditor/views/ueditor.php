<div id="editor_actions" style="display:none;">
	<a class="icon_m follow_icon  fancybox_text" id="btn-link" href="#add_link">添加链接</a>
	<a class="icon_s video_icon fancybox_text" id="btn-video" href="#add_video">添加视频</a>
	<a class="icon_l photo_icon fancybox_text" id="btn-image" href="#add_img">添加图片</a>
</div>

<div class="hide">
	<div id="add_link" class="fancy_box fancy_box_small bg_7">
	<h2>添加链接</h2>
	...
	<div id="add_video" class="fancy_box fancy_box_small bg_7">
	<h2>添加在线视频</h2>
	...
	<div id="add_img" class="fancy_box fancy_box_small bg_7">
	<h2>上传图片</h2>
	<dl class="upload">
	<?php
...
<script type="text/plain" id="editor-content">
<?php echo $this->initialContent ?>
</script>