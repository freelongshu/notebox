...
!0)});c.addInputRule(function(a){b(a)});c.commands.insertvideo={execCommand:function(b,e){e=p.isArray(e)?e:[e];for(var g=[],h=0,j,l=e.length;h<l;h++)j=e[h],g.push(a(j.url,j.width||420,j.height||280,"tmpVedio"+h,null,!0));c.execCommand("inserthtml",g.join(""),!0);g=this.selection.getRange();h=0;for(l=e.length;h<l;h++)j=this.document.getElementById("tmpVedio"+h),f.removeAttributes(j,"id"),g.selectNode(j).select(),c.execCommand("imagefloat",e[h].align)},queryCommandState:function(){var a=c.selection.getRange().getClosedNode();
